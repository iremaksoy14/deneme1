...
export const checkerSlice = createSlice({
  name: "products",
  initialState: initialCheckerState,
  reducers: {
    ...
    // createProduct
    checkerCreated: (state, action) => {
      state.actionsLoading = false;
      state.error = null;
      state.entities.push(action.payload.product);
    },
    // updateProduct
    checkerUpdated: (state, action) => {
      state.error = null;
      state.actionsLoading = false;
    ...
    // productsUpdateState
    checkerStatusUpdated: (state, action) => {
      state.actionsLoading = false;
      state.error = null;
