...
export function CheckerFetchDialog({ show, onHide }) {
  // Products UI Context
  const productsUIContext = useCheckerUIContext();
  ...
  const { products } = useSelector(
    (state) => ({
      products: selectedChecker(state.products.entities, productsUIProps.ids),
    }),
    shallowEqual
  );
