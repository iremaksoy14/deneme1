...
class CityChangeCart extends Component{
 min=0;
 max=30;
   constructor(props){
    super(props)
        ...
        tooltips: {
          callbacks: {
            title: function(tooltipItem, data) {
             ...
             return "Oluşturulan  Şehir Değişikliği"
     ...
     connection.start()
      ...
      connection.on("broadcastMessage", (message,payload) => {
        ...
        console.log("DATE",Date.now())
          ...
          console.log("Citychange Cart data ",payloadJson)
          this.setState({chart_data:payloadJson.CreateNotificationCount})
        
          })

       setInterval(() => {
        this.state.point = this.state.chart_data;
...
export default injectIntl(CityChangeCart)
